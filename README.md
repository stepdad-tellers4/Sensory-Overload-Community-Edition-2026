...
# 🎮 Sensory Overload — Community Edition

**Fast-paced retro FPS in a standalone Community Edition.**
...
Sensory Overload is a fast-paced first-person shooter inspired by classic 90s arcade shooters, combining relentless combat, chaotic neon visuals, and a driving heavy soundtrack. This Community Edition is a standalone, self-contained package that runs entirely offline with no storefront or additional software required. The full content of the base game is included in a single installer.

This build is intended for players who want a ready-to-play, offline standalone release of the full game on Windows PCs.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4403510/4490513f7584bc3410df1fa3c583c4e101a07a0b/ss_4490513f7584bc3410df1fa3c583c4e101a07a0b.1920x1080.jpg?t=1787324895" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4403510/0da780940694dae1daf8ac8ed6d9baca3b768042/ss_0da780940694dae1daf8ac8ed6d9baca3b768042.1920x1080.jpg?t=1787324895" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4403510/0ebf66f7cacd4e3d4eb72a84062e0596b6a6de83/ss_0ebf66f7cacd4e3d4eb72a84062e0596b6a6de83.1920x1080.jpg?t=1787324895" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🎯 **Run-and-Gun Combat** — High-speed encounters against relentless enemy waves across compact, aggressive levels.
- 🌆 **Neon Glitch Aesthetic** — Distinctive visual style blending CRT effects, chromatic aberration, and saturated color palettes.
- 🔫 **Diverse Arsenal** — Multiple weapons with unique handling, from rapid-fire pulse guns to heavy explosives.
- 📈 **Score-Chasing Replayability** — Rank-based scoring encourages repeated runs for higher combos and faster clears.
- 🎸 **Original Soundtrack** — Pulsing metal and synth tracks set the pace of every encounter.
- 🕹️ **Classic FPS Roots** — Movement and pacing modeled on 90s arcade shooters.
- 📦 **Self-Contained Package** — Single installer, runs offline, no additional software required.
...
- None — includes all content of the base game
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 650, 2 GB VRAM | NVIDIA GeForce GTX 1050 Ti, 4 GB VRAM |
| **Storage** | 2 GB available space | 2 GB available space on SSD |
| **Additional** | DirectX 11 compatible hardware | DirectX 11, headphones recommended |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\SensoryOverload\Saved`
